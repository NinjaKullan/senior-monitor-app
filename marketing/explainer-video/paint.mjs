...
// Usage: node paint.mjs <name> [reference.png ...]   -> candidates/<name>-<n>.png
...
for (const model of MODELS) {
  for (const gen of [{ responseModalities: ['IMAGE'], imageConfig: { aspectRatio: '9:16' } }, { responseModalities: ['IMAGE'] }]) {
