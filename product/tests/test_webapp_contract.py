...
def test_webapp_signal_names_match_the_shortcuts_on_the_phone():
    ...
    # The whole vocabulary, exactly: the shortcut keys are the names on the
    # phone, and the Android keys (spec 014 §6.6, DECISIONS 329) are what an
    # Android parent's tripwire rows say instead of a raw key.
